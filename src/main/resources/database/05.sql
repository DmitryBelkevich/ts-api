...
INSERT INTO topics (partnership_id, date, author_id, title, description) VALUES
  (1, '2018-01-01', 4, 'Отключение горячей воды', 'Внимание, 10.01.2018 с 14:00 до 15:00 будет отключена горячая вода');

INSERT INTO messages_topics (user_id, text, date, topic_id) VALUES
  (1, 'Ok', '2018-01-01', 1),
  (2, 'Ok', '2018-01-01', 1),
  (3, 'Ok', '2018-01-01', 1);
...
INSERT INTO issues (partnership_id, date, author_id, title, description, importance, process_status) VALUES
